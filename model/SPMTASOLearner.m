function [U,C,theta] = SPMTASOLearner( X,Y,rho_fr,lambda,opts)
%% Self-based Multi-task learning with Alternating Structure Optimization
...
% Objective Function
    function [F,taskF]=func(U,U0)
        ...
        taskF=cell2mat(cellfun(@(lt,t) lt+rho_fr*((U(:,t)-projU(:,t))'*(U(:,t)-projU(:,t))),temp,num2cell(1:K),'UniformOutput',false));
