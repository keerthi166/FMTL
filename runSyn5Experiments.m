...
Fs=randn(P,kappa1)*0.5;
Gs=randn(K,kappa2)*0.5;
...
save('data/synthetic/syn5_trifactor.mat')
%}
load('data/synthetic/syn5_trifactor.mat')
...
% Model Settings
models={'TriFactor'};%{'ITL','STL','MTFL','SHAMO','MTDict','MTFactor','TriFactor'};%{'CL','ELLA1','ELLA2','ELLA3','ELLA4','MTDict'};%{'STL','MMTL','SPMMTL','MTFL','SPMTFL','MTML','SPMTML','MTASO','SPMTASO'}; % Choose subset: {'STL','MMTL','MTFL','MTRL','MTDict','MTFactor'};
